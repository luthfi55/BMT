                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-shrink-0 align-self-start">
                                                <div class="dropdown">
                                                    <a class="dropdown-toggle btn-icon border rounded-circle" href="index.html#"
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card">
                                            <div class="card-header border-0 align-items-center d-flex pb-0">
                                                ...
                                                <div>
                                                    <div class="dropdown">
                                                        <a class="dropdown-toggle text-reset" href="index.html#" data-bs-toggle="dropdown"
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card">
                                            <div class="card-header border-0 align-items-center d-flex pb-0">
                                                ...
                                                <div>
                                                    <div class="dropdown">
                                                        <a class="dropdown-toggle text-muted" href="index.html#"
                                                            data-bs-toggle="dropdown" aria-haspopup="true"
                                                            aria-expanded="false">
                                        ...
                                        <div class="table-responsive" data-simplebar style="max-height: 358px;">
                                            <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><img src="assets/images/users/avatar-5.jpg.png" class="avatar-sm rounded-circle " alt="..."></td>
                                                        <td>
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="assets/images/users/avatar-5.jpg.png" class="avatar-xs rounded-circle me-2" alt="..."> Barry Dick</td>

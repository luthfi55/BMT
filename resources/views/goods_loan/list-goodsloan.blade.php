                ...
                <div class="col-lg-12">
                    <div class="card">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="{{ route('admin.goodsloan-update', $goodsLoan->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <label for="status"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-light waves-effect"
                                                data-bs-dismiss="modal">Cancel</button>
                                            <form action="{{ route('admin.goodsloan-destroy', $goodsLoan->id) }}"
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-6">
                                <div>
                                    <p class="mb-sm-0">Showing {{ $goodsLoans->firstItem() }} to {{ $goodsLoans->lastItem() }} of {{ $goodsLoans->total() }} entries</p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="float-sm-end">
                                    {{ $goodsLoans->links('pagination::bootstrap-4') }}
                                </div>
                            </div>
                        </div>
                    </div>
